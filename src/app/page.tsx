  ...
  return (
    <main className="relative overflow-hidden">
      <header className='relative bg-[linear-gradient(135deg,rgba(10,10,20,0.95),rgba(20,5,25,0.9)),url("/img/background_image.jpg")] bg-center bg-cover min-h-screen flex flex-col gap-8 items-center justify-center px-6 py-20'>
        <div className="absolute inset-0 bg-linear-to-br from-purple-900/20 via-transparent to-red-900/20 pointer-events-none"></div>
        ...
        <div className="relative z-10 flex flex-col items-center gap-8 max-w-4xl">
          ...
          <h1 className='text-transparent bg-clip-text bg-linear-to-r from-white via-gray-100 to-white text-5xl font-black max-w-3xl text-center leading-tight max-lg:text-4xl max-sm:text-3xl drop-shadow-lg animate-fade-in'>
          ...
          <div className="flex flex-col sm:flex-row gap-5 mt-6 w-full max-w-2xl justify-center">
            ...
            <Link
              href='/popular-movies'
              className='group relative flex items-center justify-center gap-3 text-white px-8 py-4 rounded-2xl bg-linear-to-r from-red-600 to-red-700 text-lg font-semibold overflow-hidden transform hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-red-600/50 max-sm:text-base flex-1'
            >
            ...
            <Link
              href='/live/top10'
              className='group relative flex items-center justify-center gap-3 text-white px-8 py-4 rounded-2xl bg-linear-to-r from-green-600 to-emerald-600 text-lg font-semibold overflow-hidden transform hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-green-600/50 max-sm:text-base flex-1'
            >
